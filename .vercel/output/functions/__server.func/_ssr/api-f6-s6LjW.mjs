...
//#region node_modules/.nitro/vite/services/ssr/assets/api-f6-s6LjW.js
...
var adminClients = [
	{
		...
		tier: "Private I",
		relationshipValue: 12127276,
		accountStatus: "Active",
		privateInvite: "Extended"
	},
	{
		id: "CL-10044",
		name: "Meridian Holdings LLP",
		tier: "Business Premier",
		relationshipValue: 482e4,
		accountStatus: "Active",
		privateInvite: "Pending"
	},
	{
		id: "CL-10089",
		name: "Harbor Capital Partners",
		tier: "Institutional",
		relationshipValue: 284e5,
		accountStatus: "Active",
		privateInvite: "Extended"
	},
	{
		...
		tier: "Personal",
		relationshipValue: 89e4,
		accountStatus: "Pending Review",
		privateInvite: "None"
	}
];
var adminPrivateQueue = [{
	id: "INV-2201",
...
function getAdminPrivateQueue() {
	return adminPrivateQueue;
}
/** GET /v1/bank/admin/loan-queue */
function getAdminLoanQueue() {
...
//#endregion
export { getBankDashboard as a, getBusinessServices as c, getMarketingSections as d, getPrivateBanking as f, getTransferHistory as h, getBankAccounts as i, getDepositProducts as l, getRecentActivity as m, getAdminLoanQueue as n, getBankDescription as o, getPrivateMetrics as p, getAdminPrivateQueue as r, getBusinessMetrics as s, getAdminClients as t, getLendingProducts as u };
