...
import { t as Route$36 } from "../_ticker-BFwNZc7e.mjs";
import { a as getExchangeUrl, c as getTerminalUrl, i as getCurrentSubdomain, l as productHomePaths, n as ThemeProvider, o as getMainSiteUrl, r as getBankUrl, t as THEME_INIT_SCRIPT } from "./theme-c8YCLp4t.mjs";
...
import { t as Route$37 } from "./owner-CfmLNhRh.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-B_KDGzmQ.js
...
function getProductForPath(pathname) {
...
*/
function resolveSubdomainRedirect(pathname) {
	const current = getCurrentSubdomain();
	if (!current || current === "main") return null;
	if (pathname === "/") return {
		type: "internal",
		to: productHomePaths[current]
	};
	const pathProduct = getProductForPath(pathname);
	if (pathProduct === current) return null;
	if (pathProduct === "main") return {
		type: "external",
...
var Route$35 = createRootRouteWithContext()({
	beforeLoad: ({ location }) => {
		...
		if (!target) return;
		if (target.type === "external") throw redirect({ href: target.href });
...
var $$splitComponentImporter$32 = () => import("./governance-Cn1CPlN5.mjs");
...
var $$splitComponentImporter$29 = () => import("./routes-BD6eRO9q.mjs");
...
var $$splitComponentImporter$28 = () => import("./terminal-C97A_Wcg.mjs");
...
var $$splitComponentImporter$27 = () => import("./exchange-VUsjQyTu.mjs");
...
var $$splitComponentImporter$26 = () => import("./bank-BmP-dGI3.mjs");
