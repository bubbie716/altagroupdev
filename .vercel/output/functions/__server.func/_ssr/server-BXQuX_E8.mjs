...
import { n as getResponse, r as requestHandler } from "./request-response-UDjZqsY1.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CojJi2-I.mjs");
