...
import { s as getProductNavUrl, u as useTheme } from "./theme-c8YCLp4t.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { n as Moon, t as Sun } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-nav-CiEv8NB3.js
...
function NavItem({ href, active, children }) {
	const className = cn("relative rounded-md px-3 py-1.5 text-[13px] tracking-wide text-muted-foreground transition-colors duration-200 hover:text-foreground", active && "text-foreground after:absolute after:inset-x-2.5 after:-bottom-[17px] after:h-[2px] after:rounded-full after:bg-gold");
...
function SiteNav() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				homeHref.startsWith("http") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
					href: homeHref,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					...
					children: links.map((l) => {
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavItem, {
							href: getProductNavUrl(l.product, l.path),
							active: l.match ? pathname.startsWith(l.match) : pathname === l.path,
							children: l.label
						}, l.id);
					})
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						terminalHref.startsWith("http") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
							href: terminalHref,
