...
const DISCORD_SKIP_ACTIONS = new Set([
  ...
  "DEAL_ROOM_CUSTOMER_REPLY_RECEIVED",
  "DEAL_ROOM_MESSAGE_SOURCE_DISCORD",
  "DEAL_ROOM_DISCORD_MESSAGE_SYNCED_TO_WEBSITE",
  "DEAL_ROOM_WEBSITE_MESSAGE_SYNCED_TO_DISCORD",
...
const ACTION_LABELS: Record<string, string> = {
  ...
  BANK_MANUAL_DEBIT_POSTED: "Manual debit posted",
  BANK_FEE_POSTED: "Fee posted",
  BANK_REVERSAL_POSTED: "Reversal posted",
  BANK_CORRECTION_POSTED: "Correction posted",
  BANK_ACCOUNT_FROZEN: "Account frozen",
  BANK_ACCOUNT_UNFROZEN: "Account unfrozen",
  BANK_ACCOUNT_RESTRICTED: "Account restricted",
  BANK_ACCOUNT_UNRESTRICTED: "Restriction removed",
  BANK_ACCOUNT_HOLD_PLACED: "Account hold placed",
  BANK_ACCOUNT_HOLD_RELEASED: "Account hold released",
  BANK_WITHDRAWAL_HOLD_PLACED: "Withdrawal hold placed",
  BANK_WITHDRAWAL_HOLD_RELEASED: "Withdrawal hold released",
  BANK_ACCOUNT_CLOSED: "Account closed",
  BANK_ACCOUNT_REOPENED: "Account reopened",
  BANK_TRANSACTION_UNDER_REVIEW: "Transaction under review",
