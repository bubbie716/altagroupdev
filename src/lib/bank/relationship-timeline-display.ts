...
export function timelineEventTypeLabel(type: RelationshipTimelineEventTypeCode): string {
  const labels: Record<RelationshipTimelineEventTypeCode, string> = {
    ...
    ALTA_CARD_RATE_CHANGED: "Alta Card Rate Reduced",
    ...
    PRIVATE_BANKING_ELIGIBLE: "Relationship Program Update",
    ALTA_PRIVATE_INVITED: "Relationship Program Update",
    PRIVATE_BANKING_CLIENT: "Relationship Program Update",
