# AB-LEGAL-008 — Alta Bank Transfers and Error Resolution Terms
...
Alta Bank is not a real-world bank and these Terms do not create rights under real-world electronic-funds-transfer, deposit-insurance, or payment-services laws. The procedures below are Alta's internal customer-protection rules for its fictional and roleplay services.

## 3. Authorization

An authenticated instruction, confirmed payment, approved scheduled transfer, authorized representative action, or other recorded approval may be treated as the customer's authorization.
...
A pending or scheduled instruction is not final. A cancellation request is effective only when Alta confirms cancellation before processing reaches a point where it cannot reasonably be stopped.

## 5. Availability of Funds

Credits may be unavailable while Alta verifies a deposit, withdrawal, transfer, reversal, dispute, funding source, or account restriction. A displayed balance may differ from the amount available for immediate use.
...
- a transaction they did not authorize;
- an incorrect amount, recipient, or duplicate transfer;
- a missing transaction or statement entry;
- a failed cancellation that Alta confirmed;
- an incorrect fee or balance adjustment; or
- a request for records needed to understand a transaction.
...
- the account holder or company name;
- the affected account or transaction reference;
- the date and amount;
- the reason the customer believes an error occurred;
- the expected result; and
- supporting screenshots or records.
...
If Alta determines no error occurred, it may deny the claim and provide a concise explanation. Any temporary credit may be reversed after notice.
