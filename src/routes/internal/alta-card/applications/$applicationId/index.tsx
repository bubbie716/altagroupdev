...
function InternalAltaCardApplicationDetail() {
  ...
  return (
    <InternalPageShell title="Application review" description="Alta Card underwriting and secure deal room.">
      <Link
        ...
        <div className="space-y-6">
          <section className="rounded-xl border border-border bg-surface-1/80 p-5">
            ...
            <p className="mt-2 text-[13px] text-muted-foreground">
              Open the secure deal room to message the applicant, request documents, and manage
              review status.
            </p>
            <Link
