    ...
    <div className="mb-8 flex flex-wrap items-end gap-3">
      <label className="block">
        ...
        <select
          ...
          className="mt-2 block w-full max-w-full rounded-md border border-border bg-background px-3 py-2 text-sm shadow-none focus-visible:outline-none focus-visible:border-gold/60 focus-visible:ring-0 focus-visible:shadow-none"
        >
          {companies.map((c) => (
