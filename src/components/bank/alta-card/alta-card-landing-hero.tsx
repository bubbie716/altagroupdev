      ...
      <div className="grid gap-8 p-6 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
        <div className="relative max-w-xl">
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
            Alta Card is a standalone revolving credit product — distinct from term lending. Choose
            from tiered personal and business cards with relationship-based limits and rates.
          </p>
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="rounded-xl border border-border bg-surface-1/80 p-5">
        ...
        <p className="mt-2 text-[13px] leading-relaxed text-muted-foreground">
          One revolving credit line per cardholder. Make payments, cash advances, and Alta Pay
          purchases from your personal line.
        </p>
      </div>
      <div className="rounded-xl border border-border bg-surface-1/80 p-5">
    ...
    <div className="rounded-xl border border-gold/30 bg-gold/5 p-5 sm:p-6">
      ...
      <p className="mt-2 text-[13px] text-muted-foreground">
        {isApproved
          ...
          : "Our team is reviewing your application. You can respond to requests and track progress in your application thread."}
      </p>
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        >
          {isApproved ? "Review & accept" : "Open application"}
        </Link>
      </div>
    </div>
  );
